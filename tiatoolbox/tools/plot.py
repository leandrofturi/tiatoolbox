...
def plot_probability_maps(tile_prediction_raw, label_names_dict=LABEL_PREDICT_NAMES):
...
def plot_argmax_mask(tile_prediction_raw, tile, label_names_dict=LABEL_PREDICT_NAMES):
...
def plot_overlay(tile_prediction_raw, tile, label_names_dict=LABEL_PREDICT_NAMES, alpha=0.5):
...
tile_prediction_raw = np.load("PAD/E264810_tiles_results/0.raw.0.npy")
tile_prediction = np.argmax(tile_prediction_raw, axis=-1)

tile_file = "PAD/E264810_tiles/tile_00001_x-236851_y19958_w2056_h2464.tif"
